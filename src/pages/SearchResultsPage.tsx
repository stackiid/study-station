...
export default function SearchResultsPage() {
  ...
  return (
    <>
      <PageHero
        eyebrow="Site search"
        title="Search Study Station"
        description="Search across every course, resource, and tutorial at once."
      >
      ...
      <section className="container-page py-12 sm:py-14">
        <div className="mx-auto max-w-2xl">
          {query.trim().length === 0 ? (
            <p className="py-10 text-center text-ink-300">
              Start typing above to search the whole site.
            </p>
          ) : results.length > 0 ? (
