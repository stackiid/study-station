  ...
  return (
    <section className="flex min-h-screen items-center justify-center py-16">
      <div className="container-page flex flex-col items-center text-center">
        ...
        <p className="mt-6 font-display text-7xl font-extrabold text-teal-900/15 sm:text-8xl">404</p>
        <h1 className="-mt-6 font-display text-2xl font-bold text-teal-900 sm:text-3xl">Page not found</h1>
