...
export function GlobalSearch({ variant = "desktop" }: GlobalSearchProps) {
  ...
  // "/" opens search from anywhere on the page (unless already typing).
  useEffect(() => {
    ...
    <>
      {variant === "desktop" ? (
        ...
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-full text-teal-800 hover:bg-teal-700/8 transition-colors"
        >
          <i
      ...
      {open && (
        <div
          className={cx(
            ...
            !reducedMotion && "animate-[fadeIn_0.18s_ease-out]",
          )}
          onClick={(event) => {
        ...
        >
          <div
            ...
            className={cx(
              ...
              !reducedMotion && "animate-[scaleIn_0.2s_ease-out]",
            )}
          >
