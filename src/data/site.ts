export const site = {
  ...
  disclaimer:
    "Study Station curates and links to third-party learning content. We don't own or host any of it, and we aren't responsible for the availability or accuracy of external sites. Links may change over time - if something looks broken, let us know.",
} as const;
